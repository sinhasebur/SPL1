...
void cbc_encrypt(  int blockSize, int* key, char* filename, unsigned char* iv, char* encryption);
void cbc_decrypt( int blockSize, int* key, char* filename, unsigned char* iv, char* encryption);

void cfb_encrypt(  int blockSize, int* key, char* filename, unsigned char* iv, char* encryption);
void cfb_decrypt( int blockSize, int* key, char* filename, unsigned char* iv, char* encryption);
